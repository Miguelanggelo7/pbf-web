  ...
  return (
    <Dialog className={classes.dialog} open={props.open} onClose={props.onClose} fullWidth fullScreen={fullScreen}>
      ...
      <DialogContent>
        ...
        A través del presente aviso, The Red Kiwi S.L. informa a los usuarios del sitio web ‘www.perfectbodyfast.es’, en cumplimiento del artículo 5 de la Ley 15/1999, de 13 de diciembre, de Protección de datos, acerca de su política de protección de datos personales.
