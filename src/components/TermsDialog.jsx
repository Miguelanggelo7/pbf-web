  ...
  return (
    <Dialog disableScrollLock className={classes.dialog} open={props.open} onClose={props.onClose} fullWidth fullScreen={fullScreen}>
      ...
      <DialogContent>
        ...
        A través del presente aviso, PBF Clinic SL informa a los usuarios del sitio web ‘www.perfectbodyfast.es’, en cumplimiento del artículo 5 de la Ley 15/1999, de 13 de diciembre, de Protección de datos, acerca de su política de protección de datos personales.
PBF Clinic SL figura inscrita en el Registro Mercantil de Valladolid al tomo 8684 Libro 5971, folio 208 , hoja número V-122001, con C.I.F. B-67986802

PBF Clinic SL hace accesibles desde este sitio web a través de enlaces de hipertexto. La inclusión de vínculos con otros sitios web no implica la aprobación de sus contenidos por parte de PBF Clinic SL ni la existencia de ningún tipo de asociación entre PBF Clinic SL y sus titulares.

La copia, reproducción, transmisión, distribución o publicación de los contenidos de este sitio web están prohibidos sin el previo consentimiento expreso de PBF Clinic SL Se permite la reproducción y almacenamiento temporal de los contenidos del sitio web en tanto ello sea estrictamente necesario para el uso y visualización del sitio web desde un ordenador personal.

El usuario puede acceder a la información del sitio web sin necesidad de proporcionar ningún dato de carácter personal. No obstante, en el supuesto de que el usuario realizara alguna consulta por correo electrónico, para lo cual deberá rellenar un formulario, la información de carácter personal facilitada por usted en éste, será incorporada y tratada en un fichero cuyo destinatario y resposable es PBF Clinic SL , con domicilio en Valladolid, Camino de las Torres 109 Zaragoza y cuya finalidad es facilitarle la información por usted solicitada, así como beneficiarse de las ventajas asociadas a la cumplimentación del mismo. PBF Clinic SL actúa como responsable del fichero, con el mismo domicilio señalado anteriormente, con la finalidad de hacerle llegar ofertas comerciales ya sea por correo o través de canales electrónicos.
